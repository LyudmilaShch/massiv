...
function App() {
    ...
    function addTask(todolistID: string, title: string) {
        ...
        setTasks({
            ...tasks, //нет map и filter поэтому делаем копию вручную
...
setTasks({
    ...tasks, //копия массива
    [todolistID]:  tasks[todolistID].map(t => t.id === taskId ? {...t, isDone} : t ) // заходи в ключ, в него положили
    //весь массив tasks[todolistID], map делаем поверхностную копию: если находит совпадение, то меняй на isDone, иначе ничего не делай
    ...
    function changeFilter(todolistID: string, value: FilterValuesType) {
        setTodolists(todolists
            .map(filtered => filtered.id === todolistID
